...
---
<details>
<summary>📐 Waveguide Structure</summary>
...
<details>
<summary>🔢 Numerical Method</summary>
...
- Example at `a = 0.22 μm`: TE₀ Neff = 2.8051, TM₀ Neff = 1.8747
 <figure>
  <img src="./Slide_figure/Isotropic_TE.drawio.png" width="500">
</figure>
 <figure>
  <img src="./Slide_figure/Isotropic_TM.drawio.png" width="500">
</figure>

- Example at `a = 0.44 μm`: TE₀ Neff = 3.1973, TM₀ Neff = 3.0180
 <figure>
  <img src="./Slide_figure/Isotropic_TE_0.44.drawio.png" width="500">
</figure>
 <figure>
  <img src="./Slide_figure/Isotropic_TM_0.44.drawio.png" width="500">
</figure>
---
...
| (b) | < 0.01 (near pure TM) | 1.7337 |
 ...
 <figure>
  <img src="./Slide_figure/4_2.drawio (1).png" width="500">
</figure>
...
| (b) | < 0.01 | 1.8073 |
 ...
 <figure>
  <img src="./Slide_figure/5.drawio (1).png" width="500">
</figure>
...
-Assymmetric case 
 <figure>
  <img src="./Slide_figure/fig_6.drawio.png" width="500">
</figure>

-Symmetric case 
 <figure>
  <img src="./Slide_figure/fig_8.drawio.png" width="500">
</figure>
...
- For large `a` near the hybridization thickness (1.03 μm): strong polarization exchange occurs near θ = ±45°
 ...
 <figure>
  <img src="./Slide_figure/6_f.drawio (1).png" width="500">
</figure>

- In the symmetric waveguide, hybridization is absent even at larger thicknesses

 <figure>
  <img src="./Slide_figure/7_f2.drawio (1).png" width="500">
</figure>
---
...
- Example at `a = 0.45 μm` (symmetric):
 ...
 <figure>
  <img src="./Slide_figure/8_2.drawio (1).png" width="500">
</figure>
